...
Copyright © 2026 Azzimov

Это программное обеспечение распространяется под условиями AGPLv3.
...
**Вы НЕ можете:**
- Использовать в коммерческих целях без открытия исходников
- Продавать плагин или его модификации
- Закрывать исходный код модификаций
